# Case Study: DTPM System Impact on Controversial Contestants

This analysis simulates the **Dynamic-Threshold Percent Model (DTPM)** retrospectively on famous controversial cases.
**System Parameters**: Start Weight=0.9, End Weight=0.6, Penalty Beta=0.4
...
- **Historical Result**: 5th Place
- **DTPM Result**: Week 1
- **Why**: Ranked Last (11/11). Penalty Applied: Yes (x0.4)

> **IMPACT**: Significant correction of historical longevity.

### Bristol Palin (Season 11)
- **Historical Result**: 3rd Place
- **DTPM Result**: Week 5
- **Why**: Ranked Last (8/8). Penalty Applied: Yes (x0.4)
